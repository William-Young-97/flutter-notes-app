...
import 'package:notetaker/utilities/dialogs/password_reset_email_sent_dialog.dart';
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Column(children: [
            const Text(
              'Enter the email associated with the account\'s password you wish to reset.',
            ),
            TextField(
